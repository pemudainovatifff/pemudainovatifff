                ...
                <div class="col-md-12">
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td><a style="color: white;"
                                                href="update_event.php?id=<?php echo $rows['id_event']; ?>">
                                                <button class="btn btn-primary btn-sm">Edit</button>
                                            </a>
                                            <a style="color: white;"
                                                href="hapus_event.php?id=<?php echo $rows['id_event']; ?>">
                    ...
                    ?>
                        ...
                        <div class="card-footer">
                            <!-- Add button -->
                            <a href='../admin/isian_tambah_event.php' class='btn btn-success'>Tambah
                                Event</a>
                        </div>
                    </div>
                </div>
