...
<body>
    ...
    <section class="section-header-single">
        <img src="img/markus-winkler-cxoR55-bels-unsplash (1).jpg">
        <div class="overlay">
    ...
    <section class="section section-archive">
        <div class="container">
            <div class="row">
                <div class="content">
                    <?php
        $result = mysqli_query($koneksi, "SELECT id_news, judul, kutipan, isi, tgl_isi, gambar FROM news");
                        ...
                        <div class="content-desc">
                            ...
                            <div class="content-desc-text">
                                <ul class="breadcrumb-post">
                                    ...
                                    <li><i class="ion-bookmark"></i> <a href="news.php">News</a> &nbsp; / &nbsp;</li>
                                    <li><i class="ion-person"></i> Admin</li>
                                </ul>
                                <p>
                                    <?php echo $row['kutipan']; ?>
                                </p>
                                <a href="isinews.php?id=<?php echo $row['id_news']; ?>" class="btn btn-md btn-orange"
