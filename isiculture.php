...
// Ambil ID dari URL
$id_culture = isset($_GET['id']) ? $_GET['id'] : null;

// Pastikan ID adalah angka dan bukan karakter berbahaya
$id_culture = filter_var($id_culture, FILTER_VALIDATE_INT);
...
$result = mysqli_query($koneksi, "SELECT id_culture, judul, kutipan, isi, tgl_isi, gambar FROM culture WHERE id_culture = $id_culture");
    ...
    <nav class="navbar scrolled">
        <div class="container">
            <div class="navbar-bars">
                ...
                <a href="index.php" class="navbar-title" style="color: white;">banjrnegaraXplorer</a>
            </div>
